...
class StaffMember {
  ...
  factory StaffMember.fromJson(Map<String, dynamic> json) {
    return StaffMember(
      id: json['id'] ?? '', 
      name: json['name'] ?? '',
      email: json['email'] ?? json['email_id'] ?? '',
      phone: json['phone'] ?? json['ph_no'] ?? '',
      ...
      researchGateUrl: json['researchGateUrl'] ?? '',
  ...
  StaffMember copyWith({
    ...
    String? linkedinUrl, String? researchGateUrl, String? personalWebsite,
